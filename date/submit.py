...
_LANGUAGE_GUESS = { '.java' : 'Java', '.c' : 'C', '.cpp' : 'C++', '.h' : 'C++', '.cc' : 'C++', '.cxx' : 'C++', '.c++' : 'C++', '.py' : 'Python' }
...
_HELP_MSG = \
'''Usage: %s [-f] [-p <problem-id>] [-m <mainclsss>] [-l <lang>] [-t <tag>] [-h?] files ...
  ...
  -t specifies a tag to mark your submission. Does not affect judging.
...
[kattis]
loginurl: http://<kattis>/login
submissionurl: http://<kattis>/judge_upload
'''
...
def main():
	...
	opt.add_option('-t', '--tag', dest='tag', metavar='TAG', help='Sets submission TAG (arbitary string associated with the submission).', default="")
